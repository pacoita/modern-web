...
export class NavigationComponent implements OnInit {
  ...
  navLinks = [
    ...
    { path: '/summary', isAI: true, icon: 'assets/icons/summarize.png', alt: 'Summary icon', label: 'Summarize' },
    { path: '/prompt', isAI: true, icon: 'assets/icons/prompt.png', alt: 'Prompt icon', label: 'Prompt' },
    ...
    { path: '/back-sync', icon: 'assets/icons/background-sync.png', alt: 'Background Sync icon', label: 'Backgr. Sync' },
